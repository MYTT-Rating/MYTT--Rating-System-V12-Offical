(function () {
  ...
  if (typeof TIERS !== "undefined" && Array.isArray(TIERS)) {
    ...
    const FINAL_TIERS = [
      ...
      {min:2200,name:"Immortal",icon:"🏆",cls:"tier-immortal",badge:"v22-immortal.webp",next:2300},
  ...
  const RANKS = [
    ...
    {name:"Immortal",score:2200,badge:"v22-immortal.webp",color:"#ffd51c",line:"line-pink"},
