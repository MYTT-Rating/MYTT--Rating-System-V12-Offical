(function () {
  ...
  if (typeof TIERS !== "undefined" && Array.isArray(TIERS)) {
    ...
    const FINAL_TIERS = [
      ...
      {min:2200,name:"Immortal",icon:"🏆",cls:"tier-immortal",badge:"2200-immortal.webp",next:2300},
  ...
  const RANKS = [
    ...
    {name:"Immortal",score:2200,badge:"2200-immortal.webp",color:"#ffd51c",line:"line-pink"},
  ...
  function buildNativeRoad(road){
    road.className="homepage-rank-road mytt-native-rank-road-v37";
    ...
    road.dataset.nativeRankRoad="v37";
    road.scrollLeft=0;
  }
  ...
  window.addEventListener("pageshow",()=>{
    const road=document.querySelector(".homepage-rank-road");
    if(road&&road.dataset.nativeRankRoad!=="v37")installNativeRankJourney();
